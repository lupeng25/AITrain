...
The P1 matrix does not productize YOLOv5 segmentation, YOLOv5 P6, YOLO26, semantic segmentation, tracking, classification, pose, anomaly, YOLO-World, or YOLOE. OBB is covered by its own Ultralytics OBB v1 route and scripts, not by P1. YOLO26 support is accepted only by a passing `phase-yolo26-model-matrix-smoke.ps1 -Full` summary and does not include semantic segmentation, classification, pose, OBB, tracking, or YOLOE-26.
