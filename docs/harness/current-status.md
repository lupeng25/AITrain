...
Begin Phase 10 real detection ONNX inference and model conversion while keeping Phase 7 TensorRT acceptance pending for an external RTX / SM 75+ GPU:
...
- next consume Phase 9 checkpoint/report/ONNX artifacts in the existing C++ inference/deployment path
