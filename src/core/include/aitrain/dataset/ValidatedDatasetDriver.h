...
class ValidatedDatasetDriver : public DatasetDriver {
public:
...
protected:
    ValidatedDatasetDriver(QString driverId, QString format, Validator validator, Splitter splitter, LayoutDetector layoutDetector);
