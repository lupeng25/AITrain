...
YoloSegmentationDatasetDriverV2::YoloSegmentationDatasetDriverV2()
    : ValidatedDatasetDriverV2(QStringLiteral("yolo_segmentation"), QStringLiteral("yolo_segmentation"),
