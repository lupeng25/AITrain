...
bool failImport(OcrOfficialReportImportResultV2* result, FailureCode code,
...
bool resolveSnapshot(StorageV2* storage, const ArtifactStoreV2* store,
    const OcrOfficialReportImportSourceV2& source, const QString& component,
...
bool prepareReport(const QString& component, const OcrOfficialReportImportSourceV2& source,
    ...
    Failure* problem)
{
    ...
    prepared->artifactKind = QStringLiteral("paddleocr_%1_official_report_v2").arg(component);
...
bool ProjectWorkspaceV2::importOcrOfficialReports(const TaskId& taskId,
    ...
    const aitrain::CancellationCallback& cancellation)
{
    ...
    *result = {};
    ...
    struct Staged final { PreparedOcrReport report; QVector<RuntimeArtifactCandidateV2> candidates; };
    ...
    const QJsonObject importEvidence{
        ...
        {QStringLiteral("kind"), QStringLiteral("ocr_official_report_import_evidence_v2")},
        {QStringLiteral("acceptanceCohortId"), cohort},
        {QStringLiteral("customerDomainId"), domain},
        {QStringLiteral("evidenceClass"), evidenceClass},
        ...
        {QStringLiteral("limitations"), QJsonArray{
            ...
            QStringLiteral("只有后续 OCR Acceptance V2 的 customer_domain 四步验收成功才能生成 production accepted。")}}};
    ...
    RuntimeArtifactBundleV2 importEvidenceBundle;
    if (!commitRuntimeArtifacts(taskId, QStringLiteral("ocr_official_report_import_evidence_v2"),
