...
bool DatasetDriverRegistry::registerDriver(const DatasetDriver* driver, QString* error)
{
...
const DatasetDriver* DatasetDriverRegistry::driverForFormat(const QString& format) const
{
    return driversByFormat_.value(format.trimmed().toLower(), nullptr);
}

QStringList DatasetDriverRegistry::formats() const
{
...
QString SemanticMaskDatasetDriver::id() const
{
    return QStringLiteral("semantic_mask");
}

QString SemanticMaskDatasetDriver::version() const
{
    return QStringLiteral("2.0");
}

QStringList SemanticMaskDatasetDriver::supportedFormats() const
{
    return {QString::fromLatin1(kSemanticMaskFormat)};
}

bool SemanticMaskDatasetDriver::detect(const QString& sourcePath, DatasetInspection* inspection, const DatasetOperationContext& context, QString* error) const
{
...
bool SemanticMaskDatasetDriver::inspect(const QString& sourcePath, const QString& format, DatasetInspection* inspection, const DatasetOperationContext& context, QString* error) const
{
...
bool SemanticMaskDatasetDriver::validate(const DatasetInspection& inspection, DatasetDriverValidationResult* validation, const DatasetOperationContext& context, QString* error) const
{
...
bool SemanticMaskDatasetDriver::planSplit(const DatasetInspection& inspection, const QJsonObject& options, DatasetSplitPlan* plan, const DatasetOperationContext& context, QString* error) const
{
...
bool SemanticMaskDatasetDriver::materializeSplit(const DatasetSplitPlan& plan, const QString& stagingPath, const DatasetOperationContext& context, QString* error) const
{
...
bool SemanticMaskDatasetDriver::snapshot(const DatasetInspection& inspection, const QString& manifestPath, const DatasetSnapshotOptions& options, DatasetSnapshotResult* result, QString* error) const
{
    ...
    return createDatasetSnapshot(inspection.sourcePath, manifestPath, inspection.format, id(), version(), snapshotOptions, result, error);
}
