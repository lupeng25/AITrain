...
bool ArtifactStore::commit(const ArtifactId& artifactId,
    const TaskId& taskId,
    const QString& kind,
...
bool ArtifactStore::discardCommitted(const ArtifactId& artifactId, ProjectStore* storage, QString* error)
{
