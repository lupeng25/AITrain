...
// “总览 / 项目”页面可消费的 V2 项目级只读 ViewModel。
// 只保留聚合计数，不包含 Artifact 路径或 Worker payload。
struct ProjectSummaryViewModelV2 final {
...
class ProjectSummaryPresenterV2 final : public QObject {
    Q_OBJECT
...
public:
    explicit ProjectSummaryPresenterV2(
    ...
    const ProjectSummaryViewModelV2& viewModel() const;
...
private:
    ...
    ProjectSummaryViewModelV2 viewModel_;
    QString lastError_;
};
