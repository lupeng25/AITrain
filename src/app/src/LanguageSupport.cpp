...
QString fallbackEnglishTranslation(const QString& source)
{
    static const QHash<QString, QString> translations = {
        ...
        {QStringLiteral("项目会生成数据集、任务、模型产物和内部 SQLite  元数据。"), QStringLiteral("The project creates datasets, task artifacts, models, and internal SQLite  metadata.")},
        ...
        {QStringLiteral("打开项目后，数据集、任务、产物和环境事实都会写入 SQLite 。"), QStringLiteral("After opening a project, datasets, tasks, artifacts, and environment facts are written to SQLite .")},
