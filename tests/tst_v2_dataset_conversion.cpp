...
aitrain::v2::TaskSnapshot createTask(aitrain::v2::StorageV2* storage)
{
    ...
    task.capabilityId = QStringLiteral("dataset_conversion_v2");
    task.taskType = QStringLiteral("dataset_conversion");
    task.state = aitrain::v2::TaskState::Created;
...
struct Fixture final {
    ...
    std::unique_ptr<aitrain::v2::ArtifactStoreV2> artifacts;
    aitrain::v2::DatasetDriverRegistryV2 drivers;
    ...
    Fixture()
    {
        ...
        artifacts = std::make_unique<aitrain::v2::ArtifactStoreV2>(directory.filePath(QStringLiteral("artifact-store")));
        if (!aitrain::v2::registerBuiltinDatasetDriversV2(&drivers, &error)) qFatal("drivers failed: %s", qPrintable(error));
    }
};

aitrain::v2::DatasetConversionRequestV2 requestFor(const QString& sourcePath)
{
    aitrain::v2::DatasetConversionRequestV2 request;
...
aitrain::v2::DatasetConversionRequestV2 requestForPair(const QString& sourcePath,
...
class V2DatasetConversionTests final : public QObject {
    Q_OBJECT
...
void V2DatasetConversionTests::supportedEntryPoints_data()
{
...
void V2DatasetConversionTests::supportedEntryPoints()
{
    ...
    aitrain::v2::DatasetConversionServiceV2 service(fixture.artifacts.get(), &fixture.storage, &fixture.drivers);
    aitrain::v2::DatasetConversionArtifactV2 result;
    QString error;
...
void V2DatasetConversionTests::rejectedRoutesAreExplicitBackendUnsupported_data()
{
    QTest::addColumn<QString>("sourceFormat");
    QTest::addColumn<QString>("targetFormat");
    ...
    QTest::newRow("yolo-coco") << QStringLiteral("yolo_detection") << QStringLiteral("coco_json")
                                 << QStringLiteral("coco_or_voc_target_has_no_v2_driver");
    ...
    QTest::newRow("ocr-cross-family") << QStringLiteral("paddleocr_rec") << QStringLiteral("yolo_detection")
                                       << QStringLiteral("no_v2_target_driver");
}

void V2DatasetConversionTests::rejectedRoutesAreExplicitBackendUnsupported()
{
    QFETCH(QString, sourceFormat);
    QFETCH(QString, targetFormat);
...
void V2DatasetConversionTests::commitsOnlyAfterTargetDriverValidation()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
...
void V2DatasetConversionTests::sourceChangeAfterPlanLeavesNoArtifact()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
    ...
    bool changed = false;
    aitrain::v2::DatasetConversionServiceV2 service(fixture.artifacts.get(), &fixture.storage, &fixture.drivers,
        [&](aitrain::v2::DatasetConversionFailPointV2 point, const QString&) {
            if (point == aitrain::v2::DatasetConversionFailPointV2::AfterPlan) {
...
void V2DatasetConversionTests::vocImageChangeAfterPlanLeavesNoArtifact()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
...
void V2DatasetConversionTests::imageOutsideFrozenSourceRootLeavesNoArtifact()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
...
void V2DatasetConversionTests::injectedWriteFailureLeavesNoArtifact()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
    ...
    aitrain::v2::DatasetConversionServiceV2 service(fixture.artifacts.get(), &fixture.storage, &fixture.drivers,
        [](aitrain::v2::DatasetConversionFailPointV2 point, const QString&) {
            return point == aitrain::v2::DatasetConversionFailPointV2::AfterMaterialize;
        });
    aitrain::v2::DatasetConversionArtifactV2 result;
    QString error;
    QVERIFY(!service.convert(task.id, requestFor(source), &result, &error));
...
void V2DatasetConversionTests::unplannedOutputIsRejected()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
    const QString source = createCocoFixture(fixture.directory.filePath(QStringLiteral("unplanned-output")), 1);
    aitrain::v2::DatasetConversionServiceV2 service(fixture.artifacts.get(), &fixture.storage, &fixture.drivers,
        [](aitrain::v2::DatasetConversionFailPointV2 point, const QString& staging) {
            if (point == aitrain::v2::DatasetConversionFailPointV2::AfterMaterialize) {
...
void V2DatasetConversionTests::cancellationDuringCopyLeavesNoArtifact()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
    ...
    aitrain::v2::DatasetConversionServiceV2 service(fixture.artifacts.get(), &fixture.storage, &fixture.drivers,
        [&](aitrain::v2::DatasetConversionFailPointV2 point, const QString&) {
            if (point == aitrain::v2::DatasetConversionFailPointV2::AfterPlan) planWritten = true;
            return false;
        });
    aitrain::v2::DatasetConversionArtifactV2 result;
    QString error;
...
void V2DatasetConversionTests::sourceAndArtifactRootOverlapIsRejected()
{
    QTemporaryDir directory;
    ...
    aitrain::v2::ArtifactStoreV2 artifacts(QDir(sourceRoot).filePath(QStringLiteral("nested-artifact-store")));
    aitrain::v2::DatasetDriverRegistryV2 drivers;
    QVERIFY(aitrain::v2::registerBuiltinDatasetDriversV2(&drivers, &error));
    aitrain::v2::DatasetConversionServiceV2 service(&artifacts, &storage, &drivers);
    aitrain::v2::DatasetConversionArtifactV2 result;
    QVERIFY(!service.convert(task.id, requestFor(source), &result, &error));
...
void V2DatasetConversionTests::manySmallFilesAreFrozenAndCommitted()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
...
void V2DatasetConversionTests::sparseLargeFileIsHashedWithoutLargeAllocation()
{
    Fixture fixture;
    const auto task = createTask(&fixture.storage);
...
void V2DatasetConversionTests::portableRelativePathBoundaryIsDeterministic()
{
    {
        Fixture fixture;
        const auto task = createTask(&fixture.storage);
...
void V2DatasetConversionTests::injectedIoFailuresLeaveNoArtifact_data()
{
    QTest::addColumn<int>("operation");
    QTest::addColumn<QString>("failureCode");
    QTest::newRow("disk-full-during-materialize")
        << static_cast<int>(aitrain::v2::DatasetConversionIoOperationV2::MaterializeWrite)
        << QStringLiteral("dataset_conversion_io_disk_full");
    QTest::newRow("report-target-locked")
        << static_cast<int>(aitrain::v2::DatasetConversionIoOperationV2::ReportWrite)
        << QStringLiteral("dataset_conversion_io_target_locked");
    QTest::newRow("commit-target-busy")
        << static_cast<int>(aitrain::v2::DatasetConversionIoOperationV2::Commit)
        << QStringLiteral("dataset_conversion_io_commit_target_busy");
}

void V2DatasetConversionTests::injectedIoFailuresLeaveNoArtifact()
{
    ...
    const auto selected = static_cast<aitrain::v2::DatasetConversionIoOperationV2>(operation);
    aitrain::v2::DatasetConversionServiceV2 service(fixture.artifacts.get(), &fixture.storage, &fixture.drivers,
        {}, [selected, failureCode](aitrain::v2::DatasetConversionIoOperationV2 point, const QString&) {
...
void V2DatasetConversionTests::abandonedStagingIsRecoveredWithoutArtifact()
{
    Fixture fixture;
    QString error;
    ...
    aitrain::v2::DatasetConversionServiceV2 service(fixture.artifacts.get(), &fixture.storage, &fixture.drivers);
    aitrain::v2::DatasetConversionArtifactV2 committed;
    ...
    QString staging;
    QVERIFY(fixture.artifacts->begin(task.id, QStringLiteral("dataset_conversion_v2"), &artifactId, &staging, &error));
    QVERIFY(writeUtf8(QDir(staging).filePath(QStringLiteral("partial.bin")), QStringLiteral("partial")));
    QVERIFY(fixture.storage.transitionTask(task.id, aitrain::v2::TaskState::Created,
        aitrain::v2::TaskState::Failed,
        {aitrain::v2::FailureCode::ProcessCrashed, QStringLiteral("worker_killed"),
    ...
    QVERIFY(fixture.artifacts->begin(activeTask.id, QStringLiteral("dataset_conversion_v2"),
...
QTEST_MAIN(V2DatasetConversionTests)
#include "tst_v2_dataset_conversion.moc"
